...
pub fn computeHamiltonianMatrix(
    ...
    let hamiltonian = (0..nslater)
        ...
        .collect();
    // hamiltonian.par_iter_mut().enumerate().for_each(|(m, p)| {
    //     let mut hm = vec![Complex::new(0.0, 0.0); nslater];
    //     for n in m..nslater {
    //         let mut hmn = Complex::new(0.0, 0.0);
    //         let numuniqueorbitals: usize = totalDiff(&binstates[n], &binstates[m], M);
    ...
    //             }
    //             1 => {
    //                 hmn = calcMatrixElementDiffIn1(&binstates[n], &binstates[m], &vspin, &hspin, M);
    //             }
    //             2 => {
    //                 hmn = calcMatrixElementDiffIn2(&binstates[n], &binstates[m], &vspin, M);
    //             }
    ...
    // let mut hamiltonian =vec![Vec::new(); nslater];
    // hamiltonian.par_iter_mut().enumerate().for_each(|(m, p)| {
    //     let mut hm = vec![Complex::new(0.0, 0.0); nslater];
    //     for n in m..nslater {
    //         let mut hmn = Complex::new(0.0, 0.0);
    ...
    // let mut hh = vec![vec![Complex::new(0.0, 0.0); nslater];nslater];
    // hh.par_iter_mut().enumerate().for_each(|(m, p)| {
    //     for n in m..nslater {
    //         let numuniqueorbitals: usize = totalDiff(&binstates[n], &binstates[m], M);
    //         match numuniqueorbitals {
    //             0 => {
    //                 p[n] = calcMatrixElementIdentialDet(&binstates[n], &vspin, &hspin, M);
    //             }
    //             1 => {
    //                 p[n] = calcMatrixElementDiffIn1(&binstates[n], &binstates[m], &vspin, &hspin, M);
    //             }
    //             2 => {
    //                 p[n] = calcMatrixElementDiffIn2(&binstates[n], &binstates[m], &vspin, M);
    //             }
    //             _ => {
    ...
    //         numuniqueorbitals = totalDiff(&binstates[n], &binstates[m], M);
    //         match numuniqueorbitals {
    //             0 => {
    //                 hmn = calcMatrixElementIdentialDet(&binstates[n], &vspin, &hspin, M);
    //             }
...
#[inline(always)]
fn xor(state1: &BitArray<u64, U64>, state2: &BitArray<u64, U64>) -> BitArray<u64, U64> {
...
#[inline(always)]
fn getOrbitalMixedIndexList(state: &BitArray<u64, U64>, M: usize) -> Vec<usize> {
...
#[inline(always)]
fn totalDiff(state: &BitArray<u64, U64>, state2: &BitArray<u64, U64>, M: usize) -> usize {
