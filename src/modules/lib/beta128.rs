...
pub fn computeHamiltonianMatrix(
    binstates: Vec<BitArray<u64, U128>>,
...
#[inline(always)]
pub fn signfun(n: usize, binstate: &BitArray<u64, U128>) -> f64 {
...
#[inline(always)]
fn getsign(state: &BitArray<u64, U128>, statelist: &Vec<usize>) -> f64 {
    let mut sign = 1.0;
    for i in statelist {
        if state[*i] {
...
#[inline(always)]
fn xor(state1: &BitArray<u64, U128>, state2: &BitArray<u64, U128>) -> BitArray<u64, U128> {
...
fn getUniqueOrbitalsInMixIndexListsPlusSign(
    state1: &BitArray<u64, U128>,
    state2: &BitArray<u64, U128>,
    M: usize,
...
#[inline(always)]
fn getOrbitalMixedIndexList(state: &BitArray<u64, U128>, M: usize) -> Vec<usize> {
...
#[inline(always)]
fn totalDiff(state: &BitArray<u64, U128>, state2: &BitArray<u64, U128>, M: usize) -> usize {
